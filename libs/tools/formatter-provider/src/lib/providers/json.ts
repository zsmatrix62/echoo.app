...
import type { CommonFormatterIndention, ToolSettings } from '@echoo/types';
...
export class JsonFormatterProvider implements FormatterToolProvider<ToolFormatterJsonOptionsType> {
	Format(
		code: string,
		options: {
