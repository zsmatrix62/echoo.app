...
impl UUIDRes {
    pub fn new(uuid: Uuid) -> Self {
        ...
        let ts = uuid.get_timestamp().map_or(Timestamp(0f64, 0f32), |t| {
            let unix = t.to_unix();
            Timestamp(unix.0 as f64, unix.1 as f32)
        });
...
fn gen_uuid_v3_or_v5(version: u8, ns: &str, name: &str) -> Result<String, String> {
    let ns = match ns {
