...
import type { JsonFormatterIndention, JsonFormatterSettingsType } from './settings';
...
@Component({
	...
	providers: [
		...
		NzDrawerService,
		{
			...
			useFactory: () => {
				return ToolSettingsService.fromDefaultSettings<keyof JsonFormatterSettingsType>(JsonFormatterDefaultSettings);
			},
		},
	],
})
export class FormatterJsonComponent implements OnInit {
	...
	settings: ToolSettingsService<keyof JsonFormatterSettingsType> = inject(ToolSettingsService);
